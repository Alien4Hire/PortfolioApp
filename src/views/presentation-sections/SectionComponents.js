          ...
          <Col className="ml-auto mr-auto" lg="4" md="10">
            <Container className="basic-container">
              ...
              <h5 className="description">
                I've re-styled All the Bootstrap 4 components that you need in a
                development with a new look. Besides the
                numerous basic elements, I've have also created additional
