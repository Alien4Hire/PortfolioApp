...
const items = [
    ...
    content: (
      <CardBody>
        <h5 className="card-description">
          "I'm newer to the front-end... In over my head on a project. I hired Jason for help and received Amazing work!
          He not only helped me where I was stuck, but gave me advice on how to best finish the rest of the project!"
        </h5>
        <CardFooter>
  ...
  },
  {
    ...
    content: (
      <CardBody>
        <h5 className="card-description">
          "Does Great work, always faster than quoted!"
        </h5>
        <CardFooter>
  ...
  },
  {
    ...
    content: (
      <CardBody>
        <h5 className="card-description">
          "Love his work, I will definately hire him again for future projects."
        </h5>
        <CardFooter>
            ...
            <Row>
                ...
                <Card className="card-testimonial">
                  ...
                  <CardBody>
                    <p className="card-description">
                      You create sites that just work, It has been over a year and I have had no issues
                      with the site you built for me. Thanks!
                    </p>
                    <CardFooter>
              ...
              <Col md="4">
                <Card className="card-testimonial">
                  ...
                  <CardBody>
                    <p className="card-description">
                      "The animation features you built for me are amazing!
                      Above and beyond any others I've seen on other websites."
                    </p>
                    <CardFooter>
